...
# Conjunction clause splitting patterns (restrict to strong independent transitions)
_CLAUSE_SPLIT_REGEX = re.compile(r";\s*|\b(?:however|moreover|furthermore|additionally)\b", re.IGNORECASE)
