...
class ChainOfVerificationEngine:
    ...
    def run_verification(self,
                         ...
                         independent_corroboration_pool: Optional[List[ProductionChunk]] = None,
                         llm_generate_fn: Optional[Callable[[str, str], str]] = None) -> CoVResult:
        """
        ...
        if not supported_checks:
            ...
            if active_generator is not None:
                ...
                try:
                    revised_response = active_generator(system_prompt, user_prompt)
                except Exception:
